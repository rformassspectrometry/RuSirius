...
**RuSirius** provides an R interface to the [Sirius](https://bio.informatik.uni-jena.de/software/sirius/) 
mass spectrometry software for metabolite identification. This vignette covers 
the basics of connecting to Sirius and managing projects.
...
2. A **Sirius account** (free registration at [bright-giant.com](https://bright-giant.com/))
