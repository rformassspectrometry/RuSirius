...
will try save your project in the `sirius_projects` folder in your user directory.
Note that this folder will *not* be created automatically. 
...
feautres. This is quite inefficient at the moment so limit  it to a little number of 
feature. I will improve it. 
