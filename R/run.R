...
#' @param alignedFeaturesIds `character` vector, the ids of the aligned
#'        features to process. By default, computes all.
...
#'        mass delta).
#' @param spectraSearchParams object of class `spectraMatchingParam`,
#'        containing the parameters for the spectra matching.
...
#' @param predictParams object of class `predictParam`, containing the
#'        parameters for the molecular fingerprint prediction and compound
#'        classification.
#' @param structureDbSearchParams object of class `structureDbParam`,
#'        containing the parameters for the structure annotation.
#' @param msNovelistParams object of class `deNovoStructureParam`, containing
#'        the parameters for the de novo structure generation.
...
#' @param wait `logical`, whether to wait for the job to finish. Default is
#'        `TRUE`
#'
#' @export
run <- function(sirius,
